...
/* 不要删除这段注释 */
 ...
 $config = [
		...
		*/
		...
		'list_url_regexes' => [
			'https://www.qiushibaike.com/pic/page/\d+/?s=\d+'
		],
		'fields' => [
			//文章id号
			...
			[
				'name' => 'post_content',
				'selector' => "//div[@id='single-next-link']/div[@class='content']",
				'required' => true
			],
			...
			[
				'name' => 'post_img',
				'selector' => "//div[@id='single-next-link']/div[@class='thumb']/img/@src",
				'required' => true
			],
...
//添加新的爬虫地址	
	...
	{
			for($i=6;$i<=34;$i++){
				$urlnew = "https://www.qiushibaike.com/pic/page/".$i;
